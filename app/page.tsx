          ...
          <Reveal>
            <div className="relative max-w-[480px] mx-auto lg:mx-0">
              ...
              <a
                ...
                className="absolute top-6 -left-5 bg-white rounded-xl border border-slate-100 shadow-lg px-4 py-3 max-w-[168px] hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 group"
              >
  ...
  return (
    <section id="contacto" className="py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* — copy first-person */}
        <Reveal delay={140}>
          <p className="text-base text-slate-500 leading-relaxed max-w-[46ch] mx-auto font-light mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          ...
          <Reveal delay={100}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center text-center p-7 bg-white border border-slate-100 rounded-2xl hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:border-slate-200 active:scale-[0.98] transition-all duration-300"
            >
            ...
            <div className="flex flex-col gap-2.5">
              {[PHONE, EMAIL_COM, 'terrenos@grupobriones.com.ar', 'proveedores@grupobriones.com.ar', 'calidad@grupobriones.com.ar'].map((c) => (
                <a
                  ...
                  className="text-sm text-white/50 hover:text-white/90 transition-colors font-medium flex items-center gap-2"
                >
                  {c.includes('@')
